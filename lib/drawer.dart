...
class MyDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final imageUrl="https://img.freepik.com/premium-vector/hi-word-speech-bubble-funny-lettering-typography-sticker-social-media-content_102918-48.jpg";
    return Drawer(
      child: Container(
          ...
          children: [
            DrawerHeader(
              ...
              child: UserAccountsDrawerHeader(
                margin:EdgeInsets.zero,
                accountName: Text("Yuvraj",textScaleFactor:1.4,style: TextStyle(color:Colors.white)),
              accountEmail: Text("yuvrajpratham01@gmail.com",style: TextStyle(color:Colors.white)),
              currentAccountPicture: CircleAvatar(
                backgroundImage: NetworkImage(imageUrl),
              ),),
              ),
              ListTile(leading:Icon(CupertinoIcons.home,color: Colors.white,),
